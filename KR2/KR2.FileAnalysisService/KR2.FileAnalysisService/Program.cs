...
{
    c.SwaggerDoc("v1", new() { Title = "FileAnalysisService API", Version = "v1" });
...
builder.Services.AddHttpClient<FileStoringServiceClient>();
builder.Services.AddHttpClient("QuickChart", client =>
{
    client.DefaultRequestHeaders.Add("User-Agent", "KR2.FileAnalysisService");
